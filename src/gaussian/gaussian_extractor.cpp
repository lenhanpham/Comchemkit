...
// Using universal physical constants from cck_constants.h
using namespace cck::constants::physical;
...
MemoryMonitor::MemoryMonitor(size_t max_memory_mb)
    : max_bytes(max_memory_mb == 0 ?
               cck::constants::limits::DEFAULT_MEMORY_LIMIT :
