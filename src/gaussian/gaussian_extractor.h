 ...
 * @brief Static utility class for Gaussian extractor information
 */
class GaussianExtractor {
public:
    /**
     * @brief Get header information string for output formatting
     * @return Header information string
     */
    static std::string get_header_info();
};
